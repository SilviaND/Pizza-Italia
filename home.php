...
<head>
    ...
    <title>Пицария Италия - Вкусът преди всичко - Начало</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="body xl-col-12 sm-col-6">
            ...
            <div id="slideshow-container-wrapper">
        
            <div class="slideshow-container">
            <div class="text-title">Най-поръчвани:</div>
            <div class="mySlides fade">
                <a href="./menu.php"><img src="./img/pizza-hero1.jpg" style="width: 100%;"></a>
              <div class="text">Пица Кастело</a></div>
            </div>
            
            <div class="mySlides fade">
                <a href="./menu.php"><img src="./img/pizza-hero2.jpg" style="width: 100%;"></a>
              <div class="text">Пица Салсиче</a></div>
            </div>
            
            <div class="mySlides fade">
                <a href="./menu.[h[]"><img src="./img/pizza-hero3.jpg" style="width: 100%;"></a>
              <div class="text">Пица Веритас</div>
            </div>
...
<div class="white-background xl-col-12 sm-col-6">
    <h1>Пицария Италия</h1>
    <p>Нашият девиз е <em>Вкусът преди всичко</em></p>
    <p>Пицария "Италия" умело съчетава вкусна храна, перфектно обслужване и прекрасна атмосфера за взискателния и модерен гост.</p><br>
    <p>За нас чувството на комфорт е също толкова важно, колкото и вкусната храна.</p>
    </div>
